...
export default function ConfigMDFePage() {
  return (
    <SidebarProvider
      style={
        {
      ...
      <SidebarInset>
        <header className="bg-background sticky top-0 flex shrink-0 items-center gap-2 border-b p-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>Configurações MDFe</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </header>
        <div className="flex flex-1 flex-col gap-4 p-4">
          <div className="min-h-[100vh] flex-1 rounded-xl bg-muted/50 md:min-h-min">
            <div className="p-6">
              <h1 className="text-2xl font-bold mb-4">Configurações MDFe</h1>
              <p className="text-muted-foreground">
                Configure as opções para Manifesto Eletrônico de Documentos Fiscais.
              </p>
            </div>
          </div>
        </div>
